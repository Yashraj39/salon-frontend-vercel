    ...
    <OwnerLayout>
      <div className='max-w-7xl mx-auto py-4 animate-fadeIn'>
        ...
        {showPopup && (
          <ModalPortal>
            <div
              className='fixed inset-0 z-[9999] bg-black/55 backdrop-blur-[2px] flex items-center justify-center p-4 animate-fadeIn'
              onClick={() => {
                setShowPopup(false)
            ...
            >
              <div
                className='bg-white w-full max-w-2xl rounded-3xl shadow-2xl p-6 sm:p-8 relative animate-scaleIn max-h-[92vh] overflow-y-auto'
              ...
              >
                ...
                <h2 className='text-2xl font-bold mb-1 text-gray-950 pr-12'>Add New Barber</h2>
                <p className='text-sm text-gray-500 mb-6 pr-12'>
