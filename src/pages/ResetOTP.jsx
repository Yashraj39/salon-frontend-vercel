...
export default function ResetOTP() {
  ...
  const getErrorMessage = (err, fallback = 'Invalid OTP') => {
    return (
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      toast.success('Reset OTP resent to your email')
  ...
  return (
    <div className='relative min-h-screen overflow-hidden bg-[#f8fafc]'>
      ...
      <div className='relative z-10 flex min-h-screen items-center justify-center px-4'>
        <div className='w-full max-w-xl rounded-[32px] border border-white/60 bg-white/70 shadow-[0_30px_100px_rgba(15,23,42,0.12)] backdrop-blur-xl'>
          <div className='p-6 sm:p-8 md:p-10'>
            ...
            <div>
              ...
              <p className='mt-4 text-sm leading-7 text-slate-500 sm:text-[15px]'>
                We sent a 6-digit reset OTP to your email address.
              </p>
              ...
              <div className='flex justify-between gap-2 sm:gap-3' onPaste={handlePaste}>
                {otp.map((value, index) => (
                  <input
                    ...
                    className={`h-14 w-11 rounded-2xl border-2 bg-white text-center text-lg font-bold text-slate-900 outline-none transition-all duration-300 sm:h-16 sm:w-12 sm:text-xl ${
                      value
