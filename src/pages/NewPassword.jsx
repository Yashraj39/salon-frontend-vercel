...
export default function NewPassword() {
  ...
  const getErrorMessage = (err, fallback = 'Failed to reset password') => {
    return (
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='mt-1 text-sm leading-6 text-slate-500'>
                    After submitting, your old password will no longer work and
                    you’ll be able to log in using the new one.
                  </p>
                </div>
              </div>
            </div>
